                ...
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                      <tr><th>Customer Name</th><th>Products</th><th>Contact | Email</th><th>Details</th><th>Shipping</th><th>Time</th>
                    </tr></thead>
                    <tbody>
                      <?php 
                        ...
                        while(list($order_id,$p_names,$cus_name,$contact_no,$email,$country,$details,$time,$quantity)=mysqli_fetch_array($result))
                        {	
                        echo "<tr><td>$cus_name</td><td>$p_names</td><td>$email<br>$contact_no</td><br>$country</td><td>$details</td><td>$quantity</td><td>$time</td>
