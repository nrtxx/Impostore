			...
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<label for="mobile"><i class="fa fa-envelope"></i> Nomor HP</label>
						<input type="text" id="mobile" name="mobile" class="form-control" value="'.$row["mobile"].'" required>
						<label for="adr"><i class="fa fa-address-card-o"></i> ID Akun Game</label>
				...
				<input type="hidden" name="total_count" value="'.$total_count.'">
					...
					<input type="submit" id="submit" value="Lanjut Pembayaran" class="checkout-btn">
				</form>
				</div>
			</div>
			';
				...
				<div class="row">
					<div class="col-md-12">
						<div class="newsletter">
							<p>Ingin Bergabung <strong>DENGAN KAMI</strong></p>
							<form >
								<input class="input" type="email" placeholder="Masukkan Email">
								<button class="newsletter-btn"><i class="fa fa-envelope"></i> Kirim</button>
							</form>
